						...
						<div class="table-responsive">
							<table class="table table-dark table-striped table-bordered">
								...
								{foreach from=$users item=user}
									{if $user.validFrom|date_format:'Y-m-d' <= $date|date_format:'Y-m-d' && ($user.validUntil|date_format:'Y-m-d' >= $date|date_format:'Y-m-d' || $user.validUntil == NULL) && $user.display == 1}
										<tr>
											<td class="name">
